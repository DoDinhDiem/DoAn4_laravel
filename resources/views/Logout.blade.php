                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <h4 class="text-dark-50 text-center mt-0 fw-bold">Hẹn gặp lại !</h4>
                                    <p class="text-muted mb-4">Bạn đã đăng xuất thành công.</p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Quay lại <a href="{{ route('home') }}" class="text-muted ms-1"><b>Trang chủ</b></a> hoặc <a href="{{ route('login') }}" class="text-muted ms-1"><b>Đăng nhập</b></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
