        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="{{ route('GiamGia.create') }}" class="btn btn-primary "><i
                    ...
                    <div class="table-responsive">
                        <form method="get" action="{{ route('GiamGia') }}" id="pageSizeForm">
                            ...
                            <tbody>
                                @foreach ($discount as $item)
                                    <tr>
                                        ...
                                        @if (Auth::user()->role == 1)
                                            <td>
                                                <a href="{{ route('GiamGia.edit', $item->id) }}" class="action-icon"> <i
                                                        style="font-size: 19px" class="mdi mdi-square-edit-outline"></i></a>
                                                <form method="POST" action="{{ route('GiamGia.destroy', $item->id) }}"
