                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-2">
                                @if (Auth::user()->role ==1)
                                <a href="{{ route('HoaDonXuat.create') }}" class="btn btn-primary "><i
                                    class="mdi mdi-plus-circle me-2"></i> Tạo mới</a>
                                    @endif
                            </div>
                            <div class="col-sm-10">
                                <form action="{{ route('HoaDonXuat') }}" method="GET">
                        ...
                        <div class="table-responsive">
                            <form method="get" action="{{ route('HoaDonXuat') }}" id="pageSizeForm">
                                ...
                                <tbody>
                                    @foreach ($invoice as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('HoaDonXuat.show', $item->id) }}" class="action-icon"> <i
                                                        class="mdi mdi-eye"></i></a>
                                                <a href="{{ route('HoaDonXuat.edit', $item->id) }}" class="action-icon"> <i
                                                        style="font-size: 19px" class="mdi mdi-square-edit-outline"></i></a>
                                                <form method="POST" action="{{ route('HoaDonXuat.destroy', $item->id) }}"
