        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="{{ route('Kho.create') }}" class="btn btn-primary "><i
                    ...
                    <div class="table-responsive">
                        <form method="get" action="{{ route('Kho') }}" id="pageSizeForm">
                            ...
                            <tbody>
                                @foreach ($warehouse as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Kho.show', $item->id) }}" class="action-icon"> <i
                                                    class="mdi mdi-eye"></i></a>
                                            @if (Auth::user()->role == 1)
                                                <a href="{{ route('Kho.edit', $item->id) }}" class="action-icon"> <i
                                                        style="font-size: 19px" class="mdi mdi-square-edit-outline"></i></a>
                                                <form method="POST" action="{{ route('Kho.destroy', $item->id) }}"
